...
lbl = tk.Label(root, text="Malicious Application Predication using ML", font=('times', 25,' bold '), height=1, width=70,bg="#000000",fg="#FFFFFF")
lbl.place(x=0, y=0)


frame_alpr = tk.LabelFrame(root, text=" --Display-- ", width=250, height=800, bd=5, font=('times', 14, ' bold '),bg="#6D6968",fg="#FFFFFF")
...
def Data_Preprocessing():
    ...
    load = tk.Label(root, font=("times", 15, "bold"), width=50, height=2, background="#00FF00",
                    foreground="#000000", text="Data Loaded=>Splitted into 80% for Training & 20% for Testing")
    load.place(x=300, y=110)
...
def Model_Training():
    ...
    label4 = tk.Label(root,text =str(repo),width=45,height=10,bg='#FFFFC2',fg='#040720',font=("times",15))
    label4.place(x=300,y=200)
    

    label5 = tk.Label(root,text ="Accracy : "+str(ACC)+"%\nModel saved as malicious_MODEL.joblib",width=45,height=3,bg='#FFFFC2',fg='#040720',font=("times",15))

    label5.place(x=300,y=420)
    from joblib import dump
    dump (svcclassifier,"malicious_MODEL.joblib")
    print("Model saved as malicious_MODEL.joblib")
...
button2 = tk.Button(frame_alpr, foreground="white", background="black", font=("times", 15, "bold"),
                   text="Data_Preprocessing", command=Data_Preprocessing, width=16, height=1)
button2.place(x=5, y=100)

button3 = tk.Button(frame_alpr, foreground="white", background="black", font=("times", 15, "bold"),
                   text="Model Training", command=Model_Training, width=16, height=1)
button3.place(x=5, y=160)

button4 = tk.Button(frame_alpr, foreground="white", background="black", font=("times", 15, "bold"),
                    text="Detect Malicious", command=call_file, width=16, height=1)
button4.place(x=5, y=220)

button5 = tk.Button(frame_alpr, text="Log-Out", command=window, width=16, height=1, font=('times', 15, ' bold '),bg="red",fg="white")
